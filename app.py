...
st.markdown("<center><h1>Whos the GOAT?</h1></center>",unsafe_allow_html=True)
...
def plot_goals(messi_events_data_df, ronaldo_events_data_df, barca_matches_dates_df, real_matches_dates_df):
    ...
    #Pitch with events
    p_messi = plot_events(messi_goals, 'Goals', 'blue')
    p_ronaldo = plot_events(ronaldo_goals, 'Goals', 'green')
...
def plot_assists(messi_events_data_df, ronaldo_events_data_df, barca_matches_dates_df, real_matches_dates_df):
    ...
    #Pitch with events
    p_messi = plot_events(messi_assists, 'Assists', 'blue')
    p_ronaldo = plot_events(ronaldo_assists, 'Assists', 'green')
...
def plot_shots(messi_events_data_df, ronaldo_events_data_df, barca_matches_dates_df, real_matches_dates_df):
    ...
    #Pitch with events
    p_messi = plot_events(messi_shots, 'Shots', 'blue')
    p_ronaldo = plot_events(ronaldo_shots, 'Shots', 'green')
...
def plot_free_kicks(messi_events_data_df, ronaldo_events_data_df, barca_matches_dates_df, real_matches_dates_df):
    ...
    #Pitch with events
    p_messi = plot_events(messi_free_kicks, 'Free Kicks', 'blue')
    p_ronaldo = plot_events(ronaldo_free_kicks, 'Free Kicks', 'green')
...
def plot_passes(messi_events_data_df, ronaldo_events_data_df, barca_matches_dates_df, real_matches_dates_df):
    ...
    #Pitch with events
    p_messi = plot_events(messi_passes, 'Passes', 'blue')
    p_ronaldo = plot_events(ronaldo_passes, 'Passes', 'green')
...
if __name__ == '__main__':
    ...
    st.sidebar.write('''
        ### About
        The app is to find out which player is the GOAT (Greatest of All Times). The statistical inference presents us some easily understandable results which can be analysed properly and we can arrive at the conclusion.

        The app was developed by [Mainak Chaudhuri](https://www.github.com/MainakRepositor). ''')
